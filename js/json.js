...
const preguntas = [{
            "question": '1. ¿Cuál es el lugar correcto en un documento HTML para incluir código de script que se encuentra en un fichero externo se emplea',
            ...
            "question": '2. ¿Cuál es el código XHTML correcto para hacer referencia a una hoja de estilo externa?',
